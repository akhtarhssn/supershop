    ...
    <div ref={heroRef} className="bg-white">
      ...
      <section className="bg-white py-10 border-b border-[#e8e8f0]">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-6">
          {features.map((f, i) => (
            <div
              key={f.title}
              className=" flex items-center gap-3 p-4 rounded-xl hover:bg-[#f8f8fd] transition-colors"
            >
              <div
      ...
      <section className="py-16 bg-[#f8f8fd]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="category-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {loading
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="product-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5">
            {loading
              ? Array.from({ length: 8 }).map((_, i) => (
      ...
      <section className="py-12 bg-[#f8f8fd]">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-6">
          {/* Banner 1 */}
          <div className=" relative overflow-hidden rounded-3xl bg-linear-to-br from-[#635ad9] to-[#7c6fe0] p-8 flex items-center justify-between">
          ...
          {/* Banner 2 */}
          <div className=" relative overflow-hidden rounded-3xl bg-linear-to-br from-[#fbb400] to-[#f97316] p-8 flex items-center justify-between">
            <div className="text-white">
              <p className="text-sm font-medium opacity-80 mb-1">
                Limited Time
              </p>
      ...
      <section className="py-16 bg-gray-900">
        <div className="stats-grid max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="testimonials-grid grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="testimonial-item bg-white rounded-2xl p-6 border border-[#e8e8f0] hover:shadow-lg transition-shadow"
              >
